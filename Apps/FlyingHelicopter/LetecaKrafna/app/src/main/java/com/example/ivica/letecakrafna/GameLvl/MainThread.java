...
public class MainThread extends Thread {
    ...
    public void run(){
        ...
        while (running) {
            ...
            // try lock the canvas for pixeld editing
            try {
            ...
            timeMillis = (System.nanoTime() - startTime) / 1000000; // ako dijelis s 100 000- cap na 60 FPS
            ...
            if (frameCount == FPS){
                ...
                Log.i(TAG,"Average FPS: "+averageFps);
            }
        }
    }
