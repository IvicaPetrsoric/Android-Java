...
public class MainActivity extends AppCompatActivity {
    ...
    android.os.Handler taskHandler;
    long time;
...
//   ImageButton live1Button, live2Button, live3Button, live4Button, live5Button;
    ...
    ImageButton zivoti[] = new ImageButton[5];
    int MaxZivoti=0;
...
//        live5Button = (ImageButton) findViewById(R.id.imageButton9);
        ...
        zivoti[0] = (ImageButton) findViewById(R.id.imageButton5);
        zivoti[1] = (ImageButton) findViewById(R.id.imageButton6);
        zivoti[2] = (ImageButton) findViewById(R.id.imageButton7);
        zivoti[3] = (ImageButton) findViewById(R.id.imageButton8);
        zivoti[4] = (ImageButton) findViewById(R.id.imageButton9);
    ...
    private void showAvailableLives(){
        ...
        for (int i = 0;i<5;i++) {
            if (MaxZivoti < lives) {
                zivoti[i].setVisibility(View.VISIBLE);
                MaxZivoti++;
            } else {
                zivoti[i].setVisibility(View.INVISIBLE);
            }
        }
